...
$ruta = "modulos/aplicacion/formularios/framework/clases/consultar/consultar.json.php";
...
<script type="text/javascript">
  ...
  function explorar_Click<?php echo($transaccion); ?>(button, grid) {var indices = <?php echo($itable);?>.getSelectedIndices();if (indices.length == 0) {return;}for (var i = 0; i < indices.length; i++) {var clase= <?php echo($itable);?>.getDataByRow(indices[i]).clase;MUI.Aplicacion_Framework_Clase_Consultar(clase);}}
  ...
  function crear_Click<?php echo($transaccion); ?>(button, grid) {MUI.Aplicacion_Framework_Clase_Crear('<?php echo($herencia); ?>');}
  ...
  window.addEvent("domready", function() {
    ...
    MUI.titlePanel($('central'),"<span style=\"color:#004080;\">Insside Framework JavaScript</span> / <span style=\"color:#FF0000;\">Clases</span>");
  });
</script>
